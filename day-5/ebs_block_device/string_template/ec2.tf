...
locals {
  instance_name = var.name == "granato" ? "Hello, ${var.name}" : "unnamed" # Utiliza a variável para o nome da instância
}
...
resource "aws_instance" "dev" {
  ...
  subnet_id     = var.subnet_id # Utiliza a variável para a VPC ID
